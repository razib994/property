...
const HomeHeroBanner = ({locations}) => {
    return (
        <>
    <div className="relative  bg-gray-800 h-screen" style={{backgroundImage:`url('images/hero.jpeg')`, backgroundPosition:"cover"}}>
                    ...
                    <form action="" className=" md:w-[60%] m-auto mt-4 md:mt-12 lg:mt-12 xl-mt-12 ">
                        <div className="relative flex p-1 rounded-full bg-white dark:bg-gray-800 dark:border-gray-600 border border-yellow-200 shadow-md md:p-2 ">
                            <div id="categories" className=" pt-3 pl-3 rounded-full bg-transparent w-70 md:w-80 relative md:p-4 md:flex justify-between items-center select-none ">
                                <input type="text" name="catName" id="catName" value="EXPLORE A PLACE" className="pl-0 md:pl-3 w-full bg-white text-base font-medium cursor-pointer dark:bg-transparent dark:text-gray-50" readonly/>
