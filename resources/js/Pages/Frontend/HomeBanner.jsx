...
const HomeBanner = ({banners}) => {
  return (
    <>
    <section className="h-screen cover md:bg-cover" style={{backgroundImage: `url(${banners.banner_image})`}}>
  <div className="flex h-full w-full items-center justify-center container mx-auto px-2 md:px-8">
    <div className="mx-4 md:mx-10 text-center">
      <h1 className="text-3xl sm:Estatetext-5xl capitalize tracking-widest text-white lg:text-7xl">{banners.title}</h1>
      <p className="mt-6 lg:text-lg text-white">{banners.description}</p>
    ...
    <div className="border border-gray-300 p-6 grid grid-cols-1 gap-6 bg-white shadow-lg rounded-lg"> 
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 border border-gray-200 p-2 rounded">
                            ...
                            <div className="flex border rounded bg-gray-300 items-center p-2 ">
                                ...
                                <select className="bg-gray-300 w-full focus:outline-none text-gray-700 p-2">
                    ...
                    <div className="flex justify-center"><button className="p-2 border w-full md:w-1/4 rounded-md bg-gray-800 text-white">Search</button></div>
                </div>
      </div>
    </div>
  </div>
