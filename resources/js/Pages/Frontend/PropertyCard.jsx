    ...
    <div className="peoperty relative inline-block w-full transform transition-transform duration-300 ease-in-out hover:-translate-y-2">
      ...
      >
        ...
        <div className="mt-8 grid grid-cols-1">
          ...
          <div className="">
            <a href={`https://api.whatsapp.com/send?phone=+8801616171171&text=https://furhouz.com/area/${item.location_name}/property/${item.property_id}`}  ><i className="fab fa-whatsapp mx-1 rounded-md bg-green-600 py-2 px-2 text-lg md:text-xl text-white"> Whatsapp</i></a>
