...
const ContactWantKnow = () => {
    return (
        <>
           <div class="min-h-screen bg-purple-400 flex justify-center items-center">
	<div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20 w-[90%] md:w-[30%]">
        <h2 className='text-3xl font-bold text-[#064d83]'>Send us a message!</h2>
...
ContactWantKnow.layout=(page) => <Layout title="Contact Us" children={page}/>;
export default ContactWantKnow;
