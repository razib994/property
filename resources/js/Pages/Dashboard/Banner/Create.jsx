...
e.preventDefault();
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    ...
    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="banner_image">
        Image
      </label>
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="banner_image" type="file" name="banner_image" errors={errors.banner_image}
												// value={data.email}
												onChange={(e) => setData("banner_image", e.target.value)}/>
      {/* <p className="text-red-500 text-xs italic">Please fill out this field.</p> */}
    </div>
    {errors && errors.banner_image ? <div className="text-[red] py-2">{errors.banner_image}</div> : null}
