...
e.preventDefault();
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="location_name">
        Location Name
      </label>
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="location_name" type="text" name="location_name" placeholder=" Location Name" errors={errors.location_name}
												// value={data.email}
												onChange={(e) => setData("location_name", e.target.value)}/>
      {/* <p className="text-red-500 text-xs italic">Please fill out this field.</p> */}
    </div>
    {errors && errors.location_name ? <div className="text-[red] py-2">{errors.location_name}</div> : null}
