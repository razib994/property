...
e.preventDefault();
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input type="hidden"  id="id"  name="id"  errors={errors.id}
												 value={data.id}
												onChange={(e) => setData("id", e.target.value)}/>
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="title" type="text" name="title" placeholder=" Title" errors={errors.title}
												 value={data.title}
