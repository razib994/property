                ...
                <div className="mt-7 overflow-x-auto">
                    <table className="w-full whitespace-nowrap">
                        <tbody>
                            ...
                            <tr tabindex="0" className="focus:outline-none h-16 border border-gray-100 rounded" key={i}>
                            <td>
                                <div className="ml-5">
                            ...
                            <td className="pl-5">
                                <div className="flex items-center">
                                    ...
                                    <p className="text-sm leading-none text-gray-600 ml-2">{item.rating} / {item.recived_count} <a href="https://api.whatsapp.com/send?phone=01737988947&text=https://furnished.free-blood.com/area/Gulshan/4">d</a></p>
                                </div>
                            </td>
                            <td className="pl-5">
                                <div className="flex items-center">
